...
![Version](https://img.shields.io/badge/version-1.0.6-informational)
...
dependencies {
    ...
    implementation 'br.com.finalcraft.everydatabase:everydatabase-core:1.0.6'

    // OR runtime download — your jar stays tiny, the same set is downloaded at runtime via Libby:
    //implementation 'br.com.finalcraft.everydatabase:everydatabase-libby:1.0.6'
}
```
...
implementation 'br.com.finalcraft.everydatabase:everydatabase-manager:1.0.6'
implementation 'br.com.finalcraft.everydatabase:everydatabase-core:1.0.6'
```
...
implementation 'br.com.finalcraft.everydatabase:everydatabase-manager-jedis:1.0.6'
implementation 'br.com.finalcraft.everydatabase:everydatabase-manager:1.0.6'
implementation 'br.com.finalcraft.everydatabase:everydatabase-core:1.0.6'
```
