package br.com.finalcraft.everydatabase.modules.memory.migrations;
...
import br.com.finalcraft.everydatabase.modules.memory.InMemoryMigration;
import br.com.finalcraft.everydatabase.modules.memory.InMemoryStorage;

import java.util.*;

/**
 * Test-only data migration that seeds the {@code test_players} collection with
 * 20 deterministic {@link TestPlayer} entries.
 *
 * <p>Mirrors the LocalFile seed migration of the same name: the dataset is identical,
 * which makes the in-memory and on-disk migration suites assert the same values.
 *
 * <h3>Dataset</h3>
 * <ul>
 ...
 */
public final class V000_PopulateTestPlayers extends InMemoryMigration {
